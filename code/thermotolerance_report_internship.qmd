...
if(plot.est == TRUE) {
  ...
  mtext(paste(id," ", "T", TempExpTime), side = 3, line = 1, cex = 1, font = 4)
...
psiiht(Temperature=DURIN_Methods$TempExp, FvFm=DURIN_Methods$FvFm_Final_num, control.temp=20, id=DURIN_Methods$species, TempExpTime=DURIN_Methods$TempExpTime, plot.est=T, boots=3)

t50metrics <- psiiht(Temperature=DURIN_Methods$TempExp, FvFm=DURIN_Methods$FvFm_Final_num, control.temp=20, id=DURIN_Methods$species, TempExpTime=DURIN_Methods$TempExpTime, plot.est=T, boots=3)
